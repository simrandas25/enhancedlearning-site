...
const config = {
  // REQUIRED
  appName: "EnhancedLearning",
  // REQUIRED: a short description of your app for SEO tags (can be overwritten)
  appDescription:
    "AI-powered university management platform that transforms campus operations, reduces administrative costs, and empowers faculty with intelligent automation.",
  // REQUIRED (no https://, not trailing slash at the end, just the naked domain)
  domainName: "enhancedlearning.com",
  crisp: {
  ...
  resend: {
    ...
    fromNoReply: `EnhancedLearning <noreply@resend.enhancedlearning.com>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `Dr Lee at EnhancedLearning <drlee@resend.enhancedlearning.com>`,
